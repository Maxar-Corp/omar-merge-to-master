...
export RADIANTBLUE_FILES=("cucumber-oc2s merge-to-master o2-paas ossim-private")
export OSSIMLABS_FILES=("omar omar-disk-cleanup omar-config-server omar-eureka-server omar-turbine-server omar-zuul-server omar-base omar-ossim-base ossim ossim-ci ossim-gui ossim-oms ossim-planet ossim-plugins \
